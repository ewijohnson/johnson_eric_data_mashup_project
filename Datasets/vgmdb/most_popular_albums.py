...
with open('most_popular_albums.txt', 'w', encoding='utf-8') as outfile:

    print("Rank, Album Name, Rating (#votes), Popularity", file=outfile)

    base_url = "https://vgmdb.net/db/statistics.php?do=top_rated"
    ...
    while page_num != 99:  # 98 pages of data as of 2019-10-12
        ...
        # Local Copy/Most Popular Albums (10 vote minimum) - VGMdb.html")
